...
## The Future: Snapdragon X2 Elite & X2 Elite Extreme (2026)

Qualcomm’s next generation X2 lineup marks its biggest performance jump ever.

### Snapdragon X2 Elite

- **Cores:** Up to 12 Oryon hybrid cores
- **Cache:** **34 MB**
- **GPU:** Adreno X2-90 @ **1.70 GHz**
- **Memory:** 128-bit LPDDR5X
- **Bandwidth:** **152 GB/s**
- **NPU:** **80 TOPS** (almost double X Elite)
- **CPU:** Up to **75% faster** performance at the same power
- **Process:** Advanced 3nm

The standard X2 Elite already delivers top-tier performance per watt.

---

### Snapdragon X2 Elite Extreme: The Flagship Powerhouse

The Extreme variant is built for creators, AI workloads, 3D artists, and power users.

- **Cores:** Up to **18 Oryon hybrid cores**
- **Cache:** Massive **53 MB** (vs 34 MB)
- **GPU:** Adreno X2-90 @ **1.85 GHz**
- **Memory:** 192-bit LPDDR5X
- **Bandwidth:** **228 GB/s** (vs 152 GB/s)
